package edu.nwmsu.grp4sec2.tadiparthi;
...
public class MinimalPageRankVivek {
  ...
  public static void main(String[] args) {
   ...
   // String file = "go.md";
    PCollection<KV<String, String>> pColKVpair1 = VivekKVPairMapper(p, "go.md", datFolder);
    PCollection<KV<String, String>> pColKVpair2 = VivekKVPairMapper(p, "python.md", datFolder);
    PCollection<KV<String, String>> pColKVpair3 = VivekKVPairMapper(p, "java.md", datFolder);
    PCollection<KV<String, String>> pColKVpair4 = VivekKVPairMapper(p, "README.md", datFolder);
    ...
    pColLinksString.apply(TextIO.write().to("Output_Vivek"));
    p.run().waitUntilFinish();
  }

  public static PCollection<KV<String, String>> VivekKVPairMapper(Pipeline p, String filename, String folder) {
  ...
  public static void deleteFiles() {
    ...
    for (File f : file.listFiles()) {
      if (f.getName().startsWith("Output_Vivek")) {
        f.delete();
      }
    }
  }
